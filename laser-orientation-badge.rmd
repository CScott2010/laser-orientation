...
-   data from 603 students

-   multiple courses and sections, final points and percentages
...
-   It changes the number of cases kept-- to a lesser number in this
    case.
...
```{r}
ggplot(d, aes(x = percentage_earned, y = FinalGradeCEMS)) +
  geom_point()
```
